...
async def promote(promt):
    ...
    try:
        ...
        await ultronevent.edit("My Legend master has promoted You In this Group....!! Ab party de🥳🥳")
...
async def demote(dmod):
    ...
    try:
        ...
        await ultronevent.edit(NO_PERM)
        return
    await ultronevent.edit("Demoted Successfully!Bhut ud rhe the admin bn kr aa gyy zameen pe 😏")
    if BOTLOG:
...
async def nothanos(unbon):
    ...
    try:
        ...
        await ultronevent.edit("Unbanned Successfully! Giving one more chance 😏")
        if BOTLOG:
